...
# # !pip install wine_quality-1.1.3-py3-none-any.whl
...
# from wine_quality.data_processor import generate_synthetic_data
# from wine_quality.monitoring import create_or_refresh_monitoring
...
# features = train_set.drop(columns=["quality"])
# target = train_set["quality"]

# # Train a Random Forest model
# model = RandomForestClassifer(random_state=42)
...
# spark.sql(f"""
#     INSERT INTO {config.catalog_name}.{config.schema_name}.wine_quality_features
...
#     model_serving_endpoint = f"https://{host}/serving-endpoints/wine-quality-model-serving-fe-dev/invocations"
...
#         name="wine-quality-model-serving-fe-dev", dataframe_records=[dataframe_record]
#     )
#     return response
